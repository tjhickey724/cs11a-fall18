...
public class ThreeN2 {
    ...
    * @param startingValue the initial value for the sequence, an integer
    */
    ...
    * @param currentN  the current number in a 3N+1 sequence
    * @return the next number (n/2 for n even, and 3n+1 for n odd)
    */
